 ...
 * @author sebas
 */
public class SpeacialattackKing1 {
   ...
   public void startSpecialAttack(Kings king1, Kings king2){
    ...
    private void distance_move(Kings king1, Kings king2){
       ...
       switch(pickedSpecialAttackDistance_move){
           case 1: 
               bow_and_arrow_King1(king1, king2); 
               break; 
               
           case 2: 
               rain_of_fire_King1(king1, king2); 
               break; 

           case 3: 
               smoke_bomb_King1(king1, king2);
               break; 
       } 
    }
    ...
    private void help(Kings king1, Kings king2){
       ...
       switch(pickedSpecialAttackHelp){
           case 1: 
               additional_warriors_King1(king1, king2); 
               break; 
               
           case 2: 
               ambush_King1(king1, king2); 
               break; 

           case 3: 
               health_and_care_package_King1(king1);
               break; 
       } 
    }
    ...
    private void smoke_bomb_King1(Kings king1, Kings king2){
    ...
    private void additional_warriors_King1(Kings king1, Kings king2){
    ...
    private void ambush_King1(Kings king1, Kings king2){
    ...
    private void health_and_care_package_King1(Kings king1){
